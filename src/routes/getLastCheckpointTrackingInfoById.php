<?php
$app->post('/api/Aftership/getLastCheckpointTrackingInfoById', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . "last_checkpoint/" . $post_data['args']['trackingId'];
    $body = array();
